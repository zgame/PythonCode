...
SUB_MB_S_BUY_BULLET_SKIN = 95  # 大厅兑换子弹皮肤
SUB_MB_C_COMPOUND_ITEM = 96  # 合成
SUB_MB_S_COMPOUND_ITEM = 97  # 合成
SUB_MB_C_RECHANGE_ITEM = 98  # 转换
SUB_MB_S_RECHANGE_ITEM = 99  # 转换

SUB_MB_C_GET_CHAT_SERVER_INFO = 100  # 获取聊天服务器信息
SUB_MB_S_GET_CHAT_SERVER_INFO = 101  # 获取聊天服务器信息

SUB_MB_C_NEWPLAYER_INFO = 102  # 客户端请求新手活动信息
SUB_MB_S_NEWPLAYER_INFO = 103  # 服务器返回新手活动信息
SUB_MB_C_USER_LOGINDAY_REWARD = 104  # 领取新手连续登陆奖励
SUB_MB_S_USER_LOGINDAY_REWARD = 105  # 领取新手连续登陆奖励

SUB_MB_C_USER_BONUS_MISSION_REWARD = 106  # 领取新手福利任务奖励
SUB_MB_S_USER_BONUS_MISSION_REWARD = 107  # 推送新手福利任务奖励

SUB_MB_C_LUCKY_NUMBER_INFO = 108  # 获取幸运数字活动信息
SUB_MB_S_LUCKY_NUMBER_INFO = 109  # 获取幸运数字活动信息
SUB_MB_C_LUCKY_NUMBER_TASK_INFO = 110  # 获取幸运数字任务进度
SUB_MB_S_LUCKY_NUMBER_TASK_INFO = 111  # 获取幸运数字任务进度
SUB_MB_C_GET_LUCKY_NUMBER_TASK_REWARD = 112  # 领取幸运数字任务奖励
SUB_MB_S_GET_LUCKY_NUMBER_TASK_REWARD = 113  # 领取幸运数字任务奖励
SUB_MB_C_LOOKUP_LUCKY_NUMBER = 114  # 查看幸运数字
SUB_MB_S_LOOKUP_LUCKY_NUMBER = 115  # 查看幸运数字
SUB_MB_C_GET_LUCKY_NUMBER_REWARD = 116  # 领取幸运数字奖励
SUB_MB_S_GET_LUCKY_NUMBER_REWARD = 117  # 领取幸运数字奖励
SUB_MB_C_LUCKY_NUMBER_RECHARGE = 118  # 通过幸运数字任务充值

SUB_MB_C_CARNIVAL_WELFARE_INFO = 119  # 领取狂欢福利活动信息
SUB_MB_S_CARNIVAL_WELFARE_INFO = 120  # 领取狂欢福利活动信息
SUB_MB_C_DRAW_CARNIVAL_WELFARE = 121  # 抽取狂欢福利活动数字
SUB_MB_S_DRAW_CARNIVAL_WELFARE = 122  # 抽取狂欢福利活动数字
SUB_MB_C_CARNIVAL_WELFARE_REWARD = 123  # 领取狂欢福利活动奖励
SUB_MB_S_CARNIVAL_WELFARE_REWARD = 124  # 领取狂欢福利活动奖励

SUB_MB_C_UPLOAD_REAL = 125  # 手机实名认证
SUB_MB_S_UPLOAD_REAL = 126  # 手机实名认证结果
SUB_MB_C_GET_H5_CLIENT_AWARD = 127  # 获取H5微端奖励
SUB_MB_S_ANTI_ADDICTION = 128  # 防沉迷信息
SUB_MB_S_SMT_POP_UP = 129  # 防沉迷提示信息
SUB_MB_C_DOWNLOAD_GAME = 130  # 下载小游戏领取奖励
SUB_MB_S_DOWNLOAD_GAME_RE = 131  # 下载小游戏领取奖励返回结果
SUB_MS_C_GET_RANK_CONFIGURATION = 132  # 获取排行榜信息
SUB_MS_S_GET_RANK_CONFIGURATION = 133  # 获取排行榜信息
SUB_MB_C_GET_RANK_INFO = 134  # 获取排行榜
SUB_MB_S_GET_RANK_INFO = 135  # 获取智慧赛排行榜返回结果

SUB_MB_RANK_MESSAGE_REQ = 300  # 获取名人榜留言
SUB_MB_RANK_MESSAGE_RE = 301  # 返回名人榜留言
SUB_MB_RANK_EDITOR_MESSAGE_REQ = 302  # 修改留言
SUB_MB_RANK_EDITOR_MESSAGE_RE = 303  # 返回修改结果
SUB_MB_C_RANK_BTN_REQ = 304  # 获取排行榜按钮配需
SUB_MB_S_RANK_BRN_RE = 305  # 返回排行榜按钮配需
SUB_MB_C_VERIFY_TIME = 306  # 时间验证
SUB_MB_S_VERIFY_TIME = 307  # 时间验证
SUB_MB_C_VIP_FORGE = 308  # 获取vip锻造优惠数据
SUB_MB_S_VIP_FORGE = 309  # 返回vip锻造优惠数据
SUB_MB_C_DOWNLOAD_ONE = 310  # 小游戏是否已经下载过
SUB_MB_S_DOWNLOAD_ONE_RE = 311  # 返回小游戏是否已经下载过
SUB_MB_C_PHOTON_ONE = 312  # 小游戏是否已经下载过
SUB_MB_S_PHOTON_ONE_RE = 313  # 返回小游戏是否已经下载过

SUB_C_VIP_ROOM_INFO = 314  # vip房间列表
SUB_S_VIP_ROOM_INFO = 315  # vip房间列表
SUB_C_GET_VIP_ROOM_MISSION_REWARD = 316  # 领取vip房间任务奖励
SUB_S_GET_VIP_ROOM_MISSION_REWARD = 317  # 领取vip房间任务奖励
SUB_C_GET_VIP_ROOM_RANK = 318  # 获取vip房间排行
SUB_S_GET_MG_ADVENTURE_RANK = 319  # 获取满贯大冒险积分排行

SUB_MB_S_ARENA_CHALLENGE_CONFIG = 320  # 下发挑战赛配置
SUB_MB_C_GET_USER_CHALLENGE_INFO = 321  # 获取用户挑战赛信息
SUB_MB_S_GET_USER_CHALLENGE_INFO = 322  # 获取用户挑战赛信息
SUB_MB_C_ARENA_CHALLENGE_RANK = 323  # 请求挑战赛排行
SUB_MB_S_ARENA_CHALLENGE_RANK = 324  # 请求挑战赛排行
...
SUB_MB_C_CLASSIC_PRIZE_POOL_STOCK = 49  # 获取大奖池信息
SUB_MB_S_CLASSIC_PRIZE_POOL_STOCK = 50  # 获取大奖池信息
SUB_MB_C_ACTIVITY_SIGN_THIRTY = 51  # 三十日登录签到
SUB_MB_S_ACTIVITY_SIGN_THIRTY = 52  # 三十日登录结果
...
#充值相关
SUB_MB_L2C_PRODUCT_INFO=0								# 返回产品信息，兑换比例
SUB_MB_C2L_PURCHASE_REQUEST_TRADE_NO=1				# 请求订单
SUB_MB_L2C_PURCHASE_RESPONSE_TRADE_NO=2				# 返回订单
SUB_MB_C2L_PURCHASE_DEAL_TRADE_NO=3					# 处理订单=查询？因某种原因取消？
SUB_MB_C2L_PURCHASE_RESULT=4					# 充值完成后查询金币是否增加
SUB_MB_L2C_PURCHASE_RESULT=5						# 充值完成后查询金币是否增加，返回
SUB_MB_C2L_PURCHASE_TRADE_VIEW_STATUS=6				# 充值状态
SUB_MB_L2C_PURCHASE_TRADE_VIEW_STATUS=7					# 充值状态，返回
SUB_MB_S2C_DIAMOND_EXCHANGE_LIST=8						#钻石兑换信息
SUB_MB_S2C_DIAMOND_EXCHANGE=9							#钻石兑换
SUB_MB_C2S_DIAMOND_EXCHANGE=10							#钻石兑换结果
SUB_MB_C2G_PURCHASE_QUERY_UNDEALED_TRADE=11				# 查询漏单
SUB_MB_L2C_USER_PURCHASE_BONUS_INFO=12                    # 用户加赠信息
SUB_MB_C2L_USER_PURCHASE_BONUS_INFO=13                    # 请求用户加赠信息
SUB_MB_C2L_PRODUCT_INFO=14								# 请求返回产品信息，兑换比例
SUB_MB_C2L_FIRST_PAY_INFO=15                              # 请求首冲信息
SUB_MB_L2C_FIRST_PAY_INFO=16                              # 请求首冲信息

# 消息
SUB_MB_MESSAGE_GET = 0  # 获取消息包=发送给服务器
SUB_MB_MESSAGE_BACK = 1  # 服务器发送消息包给客户端
# 消息操作
SUB_MB_C_DELETE_MESSAGE = 2  # 删除消息
SUB_MB_S_DELETE_MESSAGE = 3  # 删除消息结果
SUB_MB_C_MESSAGE_GET_GIFT = 4  # 获取礼包
SUB_MB_S_MESSAGE_GET_GIFT = 5  # 获取礼包服务器返回
SUB_MB_S_REFRESH_MESSAGE = 6  # 通知刷新邮件
SUB_MB_S_SYSTEM_MESSAGE = 7  # 跑马灯消息

SUB_MB_C_SPEAKER_SEND_MSG = 8  # 小喇叭
SUB_MB_S_SPEAKER_SEND_MSG_FAIL = 9  # 失败
SUB_MB_S_SPEAKER_SEND_MSG_BACK = 10  # 小喇叭回复

SUB_MB_S_SPEAKER_RECORD = 11  # 留言板信息
SUB_MB_C_SPEAKER_RECORD = 12  # 请求留言板信息
...
class GameServerInfo(object):
    def __init__(self):
        ...
        self.node_id = 0  # 节点索引
        self.sort_id = 0  # 排序索引
        self.server_id = 0  # 房间索引
        self.server_port = 0  # 房间端口
        self.online_count = 0  # 在线人数
        self.online_pc = 0
        self.online_andriod = 0
        self.online_ios = 0  # 在线人数
        self.full_count = 0  # 满员人数
        self.server_addr = []  # 房间地址(抛弃)
        self.server_name = ''  # 房间名称
        self.cell_score = 0
        self.min_enter_score = 0  # 最低进入分数
        self.max_enter_score = 0  # 最高进入分数
        self.server_type = 0  # 服务器类型1为财富4为比赛
        self.min_enter_vip = 0  # 最低进入VIP
        self.min_enter_cannon_lev = 0  # 最低进入炮等级
        self.server_rule = 0  # 服务器规则
